<template>
  ...
  <!-- hero -->
  <div class="hero bg-secondary-300 py-16">
    <!-- container -->
      ...
      <div class="hero-wrapper grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
        ...
        <div class="hero-text col-span-7">
          <h1 class="uppercase leading-none font-black	text-6xl md:text-5xl max-w-xl text-primary-500 text-left">Prêt à
            prendre
            soin de votre peau ?</h1>
          <p class="text-gray-800 text-3xl leading-relaxed text-left mt-8 font-semibold">Découvrez nos derniers
            articles</p>
          <div class="get-app flex space-x-5 mt-10 justify-center md:justify-start">
            <button class="apple bg-white shadow-md px-3 py-2 rounded-lg flex items-center space-x-4">
              ...
              <div class="text">
                <p class=" text-xs text-gray-600" style="font-size: 0.5rem;">Télécharger sur</p>
              ...
              <div class="image">
                <svg
                  ...
                  <g transform="translate(-16.896)">
                    <path d="M270.336,234.965,34.39,462.165A40.146,40.146,0,0,1,16.9,428.672V41.258A40.146,40.146,0,0,1,34.39,7.765Z"
                        fill="#2196f3"/>
                    <path d="M352.9,155.6l-82.56,79.36L34.39,7.765a31.446,31.446,0,0,1,2.773-1.92A40.363,40.363,0,0,1,77.91,5.2Z"
                        fill="#4caf50"/>
                    <path d="M452.95,234.965a40.791,40.791,0,0,1-21.333,36.267L352.9,314.325l-82.56-79.36L352.9,155.6l78.72,43.093A40.791,40.791,0,0,1,452.95,234.965Z"
                        fill="#ffc107"/>
                    <path d="M352.9,314.325,77.91,464.725a40.9,40.9,0,0,1-40.747-.64,31.44,31.44,0,0,1-2.773-1.92l235.947-227.2Z"
                        fill="#f44336"/>
                  </g>
                </svg>
              </div>
  ...
  <!-- BLOG -->
  <div class="template py-16">
    <section class="text-left px-8">
      <h2 class="uppercase leading-none font-black text-primary-500 text-5xl mb-2">Le blog Belhom</h2>
      <h3 class="text-primary-300 text-3xl mb-5">Ensemble contre le gaspillage alimentaire<br/>Apprenez, comprenez,
        soyez
        le changement !</h3>
    </section>
    ...
    <section class="grid grid-cols-1 md:grid-cols-3 gap-16 max-w-6xl m-auto py-4">
        <div class="my-3 col-md-4 col-12">
          <a href="/fr/blog/utiliser-feuille-artichaut" class="">
            <div class="blog-card text-xl h-full bg-white shadow-xl rounded-3xl">
              <img src="@/assets/placeholder.jpg" class="h-48 w-full object-cover overflow-hidden rounded-t-3xl">
              <div class="p-6 text-left">
                <small class="subheader uppercase text-sm">Recettes & Astuces</small>
                <h4 class="leading-none text-2xl font-black text-primary-500 mb-0">Que faire des restes de feuilles d’artichauts ?</h4>
