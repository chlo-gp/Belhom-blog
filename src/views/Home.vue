<template>
  <body class="bg-secondary-300 antialiased" x-data="{ isOpen : false}">
    <!-- hero -->
    <div class="hero bg-secondary-300 container px-4 sm:px-8 lg:px-16 xl:px-20 mx-auto">
      <!-- hero wrapper -->
      <div
        class="
          mb-20
      ...
      >
        ...
        <div class="hero-text col-span-7">
          ...
          <p
            ...
            "
          >
            Ici tu trouveras toutes les bonnes astuces beauté pour sublimer
            l’homme que tu es.
          </p>
          <div
            class="
          ...
          >
            ...
            >
              ...
              <div class="text">
                <p class="text-xs text-gray-600" style="font-size: 0.5rem">
                  Télécharger sur
                </p>
    ...
    <div class="container m-auto text-center">
      <h2 class="text-primary-500 font-black text-4xl leading-tight mb-5">
        Un homme oui,<br />
        mais qui prend soin de lui c’est mieux !
      </h2>
      <p class="text-2xl px-4 md:px-24">
        Et oui, contrairement à ce que certaines personnes peuvent dire, tu as
        le droit (et le devoir) en tant qu’homme de prendre soin de ta peau, de
        ton corps, de ta barbe, de tes cheveux.
        <br />
        Tout cela fait partie de ton capital santé et c’est très important de le
        préserver.
      </p>
    </div>
    ...
    <div class="md:py-16 py-5 container m-auto px-6">
      <div class="lg:flex justify-between items-center">
        <div class="lg:w-6/12 lg:p-0 p-7 text-left">
          <h2 class="text-4xl font-bold leading-tight mb-5 text-primary-500">
            Et non s’occuper de soi ce n’est pas dur…
          </h2>
          <p class="text-xl">
            Tu crois que Thomas Pesquet est monté sur la lune sans être préparé
            ? Bien sûr que non !
            <br />
            Alors oui, au début ça peut faire peur, tous ces produits beauté,
            mais quand on veut, on peut monsieur !
          </p>
        </div>
        <div
          class="
          ...
          "
        >
          <img src="@/assets/homme-smile.jpg" class="img-home rounded-lg" />
        </div>
      </div>
    </div>
    ...
    <div class="md:py-16 py-5 container m-auto px-6">
      <div class="flex flex-col lg:flex-row justify-between items-center">
        <div
          ...
          "
        >
          <img src="@/assets/rasage.jpeg" alt="" class="img-home2 rounded-lg" />
        </div>
        <div class="lg:w-6/12 order-2 pt-5 md:pt-0 text-right">
          <h2 class="text-4xl font-bold leading-tight mb-5 text-primary-500">
            Des produits éthiques pour un être magnifique.
          </h2>
          <p class="text-xl">
            Si tu dois commencer par prendre soin de toi autant commencer avec
            des produits bons pour ton organisme n’est-ce pas?
            <br />
            Sur notre blog, tu trouveras uniquement des suggestions de marques
            éthiques et responsables sélectionnées par nos soins.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="flex flex-col bg-primary-500 text-secondary-300 py-20">
      ...
      <p class="text-xl font-thin px-8 md:px-40 pb-10">
        Tu es intéressé par les cosmétiques, les routines beauté et les produits
        naturels ?
        <br />
        Rejoins l'aventure, tu vas briller de mille feux avec Belhom !
      </p>
      <!-- Auth Card -->
      <div
        class="
      ...
      <div class="flex justify-center py-8">
        ...
        <i class="fab fa-linkedin text-5xl px-5"></i>
      </div>
    </div>

    <!-- BLOG -->
    <section
      class="flex md:flex-row flex-col justify-around max-w-6xl m-auto py-16"
    >
      <div class="text-left mx-5 md:m-auto">
        <h2 class="text-4xl font-black leading-tight mb-5 text-primary-500">
          N’oublie pas de découvrir nos derniers articles, conseils et autres
          actualités !
        </h2>
        <p class="text-xl mb-5">
          Besoin d’un conseil ? D’une suggestion de marque éthique ? Ou encore
          des astuces pour prendre soin de toi ? Nous sommes heureux de te dire
          que tu es au bon endroit bel homme !
        </p>
        <router-link to="/blog">
          <button
            class="
      ...
      <div class="md:ml-32 pt-8 mx-8 md:mx-0 md:pt-0 max-w-sm">
        <router-link :to="{ name: 'Article', params: { id: 1 } }" class="">
          <div class="blog-card text-xl h-full bg-white shadow-xl rounded-3xl">
            <img
              src="@/assets/rasage.jpg"
              class="h-48 w-full object-cover overflow-hidden rounded-t-3xl"
            />
            <div class="p-6 text-left">
              <small class="subheader uppercase text-sm"
                >Conseils et astuces</small
              >
              <h4
                class="leading-none text-2xl font-black text-primary-500 mb-0"
              >
                COMMENT ÉVITER LES POILS INCARNÉS QUAND TU TE RASES ?
              </h4>
            </div>
          </div>
        </router-link>
...
export default {
  ...
  data() {
    return {
       typeValue: '',
        typeStatus: false,
        typeArray: ['ta peau ?', 'tes cheveux ?', 'ta barbe ?', 'toi ?'],
        typingSpeed: 100,
        erasingSpeed: 100,
        newTextDelay: 500,
        typeArrayIndex: 0,
