<template>
  <div class="about bg-secondary-300">
    <div class="px-8 tablet:px-24">
      <h1 class="tablet:px-32 mb-8 text-primary-500 font-black text-3xl">
        Mentions légales
      </h1>
      <div class="text-left">
        <h3 class="my-6 text-primary-500 font-black text-xl">
        ...
        <p>
          ...
          du site
          <router-link to="/" class="font-bold text-primary-500">https://belhom.net</router-link> l'identité des
          différents intervenants dans le cadre de sa réalisation et de son
          suivi :
        </p>
        <strong>Propriétaire</strong> : Belhom - 56437845329845- 4 Rue de la
        Villette 69003 LYON
        <p>
          <strong>Créateur</strong> :
          <router-link to="/" class="font-bold text-primary-500">https://belhom.net</router-link>
        </p>
        <p>
          <strong>Responsable publication</strong> : Marine STROEBEL-
          marine.stroebel@gmail.com
        </p>
        <p>
        ...
        <p>
          <strong>Webmaster</strong> : Chloé GALLEGO -
          chloe.gallego1501@gmail.com
        </p>
        <p>
          <strong>Hébergeur</strong> : OVH - 2 rue Kellermann - BP 80157 59053
          ROUBAIX CEDEX 1
        </p>
        <p>
          <strong>Crédits</strong> : Marine STROEBEL, Chloé GALLEGO, Arthur
          MICONNET (webdesigner), Prune VOILLOT.
        </p>
        <p>
        ...
        <p>
          ...
          <router-link to="/" class="font-bold text-primary-500">https://belhom.net</router-link> implique
          ...
          <router-link to="/" class="font-bold text-primary-500">https://belhom.net</router-link> sont donc invités
        ...
        <p>
          ...
          décidée par Chloé GALLEGO, qui s'efforcera alors de communiquer
          préalablement aux utilisateurs les dates et heures de l'intervention.
        </p>
        <p>
          Le site <router-link to="/" class="font-bold text-primary-500">https://belhom.net</router-link> est mis à
          jour régulièrement par Chloé GALLEGO. De la même façon, les mentions
        ...
        <p>
          Le site <router-link to="/" class="font-bold text-primary-500">https://belhom.net</router-link> a pour
          objet de fournir une information concernant l'ensemble des activités
          de la société.
        </p>
        <p>
          maxime chadel s'efforce de fournir sur le site
          <router-link to="/" class="font-bold text-primary-500">https://belhom.net</router-link> des informations
        ...
        <p>
          ...
          <router-link to="/" class="font-bold text-primary-500">https://belhom.net</router-link> sont données à
          titre indicatif, et sont susceptibles d'évoluer. Par ailleurs, les
          renseignements figurant sur le site
          <router-link to="/" class="font-bold text-primary-500">https://belhom.net</router-link> ne sont pas
        ...
        <p>
          Belhom est propriétaire des droits de propriété intellectuelle ou
          détient les droits d'usage sur tous les éléments accessibles sur le
          site, notamment les textes, images, graphismes, logo, ic&ocirc;nes,
          sons, logiciels.
        </p>
        <p>
        ...
        <p>
          Belhom ne pourra être tenu responsable des dommages directs et
          indirects causés au matériel de l'utilisateur, lors de l'accès au site
          <router-link to="/" class="font-bold text-primary-500">https://belhom.net</router-link>, et résultant
        ...
        <p>
          Belhom ne pourra également être tenu responsable des dommages
        ...
        <p>
          ...
          l'espace contact) sont à la disposition des utilisateurs. Belhom se
          ...
          protection des données. Le cas échéant, Belhom se réserve également la
          ...
          utilisé (texte, photographie&hellip;).
        </p>
        <h3 class="my-6 text-primary-500 font-black text-xl">
        ...
        <p>
          ...
          loi n° 78-87 du 6 janvier 1978, la loi n° 2004-801 du 6 août
          2004, l'article L. 226-13 du Code pénal et la Directive Européenne du
          24 octobre 1995.
        </p>
        <p>
          A l'occasion de l'utilisation du site
          <router-link to="/" class="font-bold text-primary-500">https://belhom.net</router-link>, peuvent êtres
          recueillies : l'URL des liens par l'intermédiaire desquels
          l'utilisateur a accédé au site
          <router-link to="/" class="font-bold text-primary-500">https://belhom.net</router-link>, le fournisseur
          d'accès de l'utilisateur, l'adresse de protocole Internet (IP) de
          l'utilisateur.
        </p>
        <p>
          En tout état de cause, Belhom ne collecte des informations
          personnelles relatives à l'utilisateur que pour le besoin de certains
          services proposés par le site
          <router-link to="/" class="font-bold text-primary-500">https://belhom.net</router-link>. L'utilisateur
          ...
          <router-link to="/" class="font-bold text-primary-500">https://belhom.net</router-link> l'obligation ou
        ...
        <p>
          ...
          <router-link to="/" class="font-bold text-primary-500">https://belhom.net</router-link> n'est publiée à
          l'insu de l'utilisateur, échangée, transférée, cédée ou vendue sur un
          support quelconque à des tiers. Seule l'hypothèse du rachat de Belhom
        ...
        <p>
          Le site <router-link to="/" class="font-bold text-primary-500">https://belhom.net</router-link> contient
          un certain nombre de liens hypertextes vers d'autres sites, mis en
          place avec l'autorisation de Belhom. Cependant, Belhom n'a pas la
        ...
        <p>
          ...
          <router-link to="/" class="font-bold text-primary-500">https://belhom.net</router-link> est susceptible
        ...
        <p>
          ...
          <router-link to="/" class="font-bold text-primary-500">https://belhom.net</router-link> est soumis au
        ...
        <p>
          Informations personnelles : &laquo; les informations qui permettent,
          sous quelque forme que ce soit, directement ou non, l'identification
          des personnes physiques auxquelles elles s'appliquent &raquo; (article
